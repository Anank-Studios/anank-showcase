        ...
        <section className="px-5 py-24 md:px-10 md:py-36 lg:px-14">
          <div className="mx-auto max-w-[1400px]">
            ...
            <div className="mt-14 grid grid-cols-1 gap-8 md:grid-cols-3">
              {[
                {
                  before: images.antes1,
                  after: images.depois1,
                  caption: 'Protocolo Aurora · 3 sessões',
                },
                {
                  before: images.antes2,
                  after: images.depois2,
                  caption: 'Protocolo Vórtice · sessão única',
                },
                {
                  before: images.antes3,
                  after: images.depois3,
                  caption: 'Protocolo Nocturne · 6 sessões',
                },
              ].map((pair) =>
