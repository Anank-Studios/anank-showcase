 ...
 */
export function FornoFooter({ demo }: { demo: Demo }) {
  return (
    <footer className="border-t border-line bg-[color:var(--brand-surface)]">
      <div className="mx-auto max-w-[1400px] px-5 py-16 md:px-10 md:py-20 lg:px-14">
        <div className="grid gap-12 md:grid-cols-[1.4fr_1fr_1fr]">
          <div>
            <p className="font-display text-[clamp(2.25rem,6vw,3.75rem)] leading-[1.0]">Forno</p>
          ...
          <div>
            ...
            <nav className="mt-7 flex flex-col gap-1.5" aria-label="Navegação do rodapé">
              <IntentLink href="/demo/forno/cardapio" className="text-[14px] hover:text-accent">
                Cardápio
              </IntentLink>
              <IntentLink href="/demo/forno/a-casa" className="text-[14px] hover:text-accent">
                A casa
              </IntentLink>
              <IntentLink href="/demo/forno/sacola" className="text-[14px] hover:text-accent">
                Sacola
              </IntentLink>
            </nav>
          </div>
