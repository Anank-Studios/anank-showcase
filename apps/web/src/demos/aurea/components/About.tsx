  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-[minmax(0,380px)_1fr] lg:gap-16">
        ...
        <div>
          <Reveal delay={0.06}>
            <p className="label-caps text-accent">Sobre</p>
          ...
          <Reveal delay={0.12}>
            <div className="mt-6 space-y-4 text-base leading-relaxed text-muted">
              <p>
                São catorze anos atrás da cadeira. Comecei cortando cabelo na casa da minha mãe,
                fiz formação em colorimetria em São Paulo e passei um bom tempo trabalhando na
                agenda de outras pessoas até decidir que queria fazer do meu jeito — com calma, e
                sem empurrar serviço que o cliente não pediu.
              </p>
              <p>
          ...
          <Reveal delay={0.18}>
            <p
              className="font-display mt-8 -rotate-3 text-[30px] text-accent italic"
            >
              Bruna Sartori
            </p>
